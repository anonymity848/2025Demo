        ...
        messages = [
            {
                "role": "user",
                "content": (
                    f"There are two cars that are described by attributes Year, Price, Mileage, Tax.\n"
                    f"Car 1: {p1.coord}\n"
                    f"Car 2: {p2.coord}\n"
                    f"Describe their similarities and differences within 50 words respectively.\n"
                )
            }
        ]
